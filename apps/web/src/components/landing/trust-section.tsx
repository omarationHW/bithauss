...
const testimonials = [
  {
    ...
    image: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/confinza1.webp',
    quote:
  ...
  },
  {
    ...
    image: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/confianza2.webp',
    quote:
  ...
  },
  {
    name: 'Angela Ramírez',
    role: 'Compradora',
    image: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/confianza3.webp',
    quote:
...
const partners = [
  { name: 'Notaría 45', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/Notaria45.webp' },
  { name: 'Colegio de Notarios', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/Colegiodenotarios.webp' },
  { name: 'AMPI', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/AMPI.webp' },
  { name: 'PROFECO', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/PROFECO.webp' },
  { name: 'CNBV', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/CNBV.webp' },
  { name: 'RAN', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/Logo_RAN.webp' },
]
