...
const testimonials = [
  {
    ...
    image: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/confinza1.png',
    quote:
  ...
  },
  {
    ...
    image: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/confianza2.png',
    quote:
  ...
  },
  {
    name: 'Angela Ramírez',
    role: 'Compradora',
    image: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/confianza3.png',
    quote:
...
const partners = [
  { name: 'Notaría 45', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/Notaria45.jpg' },
  { name: 'Colegio de Notarios', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/Colegiodenotarios.png' },
  { name: 'AMPI', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/AMPI.png' },
  { name: 'PROFECO', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/PROFECO.png' },
  { name: 'CNBV', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/CNBV.png' },
  { name: 'RAN', src: 'https://bithauss-images-fpdpe5auefacdweh.z03.azurefd.net/images/Logo_RAN.png' },
]
